...
class Details extends React.Component {
  ...
  componentDidMount () {
    // component will mount runs on server and browser
    // this does not, making it the perfect place to do ajax calls. 
    // this COULD live in redux, its up to you.
  ...
  render () {
    ...
    if(this.state.omdbData.imdbRating){
      ...
      rating = <h3 className='video-rating'>No Rating</h3>
    }
    return (
